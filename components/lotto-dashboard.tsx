...
function DrawCard({ daily = false }: { daily?: boolean }) {
...
export function LottoDashboard() {
  ...
  return <main className="lotto-shell">
    ...
    <section className="draws-section" id="draws"><div className="section-heading"><h2>LIVE DRAWS</h2><span><i /> UPDATING LIVE</span></div><div className="draw-grid"><DrawCard /><DrawCard daily /></div></section>
